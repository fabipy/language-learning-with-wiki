 ...
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * 
 * This version is intended for JUnit test only.
 */
public class ParserTestVersion {
	...
	/** Message page to be return, when problems occur. Maybe the only we to communicate with the 
	 * end user, since he could be someone then the one responsible for running the service.*/
	 ...
	 */
	public ParserTestVersion(String path) {
		// Parameter check.
		...
		try {
			...
			System.out.println("An exception occured while reading in: " + e.getMessage());
		}
	}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void initSupportedLanguages(String filename) throws IOException {
		// Parameter check.
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public File initDirectory(String directory) {
		// Parameter check.
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void initLookUpTables(File dir) throws IOException {
		// Parameter check.
		if (dir == null) {
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void readInLookUpTable(String filename, Map<String, Map<Integer, String>> map) throws IOException {	
		// Parameter check.
		if (filename == null || filename.isEmpty()) {
			throw new IllegalArgumentException("Invalid Parameter: " +  filename);
		}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public boolean isWikiPage(String url) {
		// Parameter check.
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public String extractLanguage(String url) {
		// Parameter check.
		if (url == null || url.isEmpty()) {
			throw new IllegalArgumentException("Invalid Parameter: " +  url);
		}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void selectCorrespondigMap(WordClass wordClass) {
		// Parameter check.
		if (wordClass == null) {
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void processParagraphs(Document doc) {
		// Parameter check.
		if (doc == null) {
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public String changeTextRandom(String text){
		// Parameter check.
		if (text == null || text.isEmpty()) {
			throw new IllegalArgumentException("Invalid Parameter: " +  text);
		}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public String changeTextArticlesAndPronouns(String text) {	
		// Parameter check.
		if (text == null || text.isEmpty()) {
			throw new IllegalArgumentException("Invalid Parameter: " +  text);
		}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public void processLinks(Document doc) {
		// Parameter check.
		if (doc == null) {
			throw new IllegalArgumentException("Invalid Parameter: " +  doc);
		}
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public Map<Integer, String> removeWordsRandomly(List<String> wordList) {
		// Parameter check.
		if (wordList == null) {
	 ...
	 * @throws IllegalArgumentExcpetion - if parameter is not valid.
	 */
	public String buildSelectTag(Map<Integer, String> removedWords) {
		// Parameter check.
	...
	/** FOR TESTING PURPOSES ONLY. */
	public Map<String, Map<Integer, String>> getMapArticles() {
		return mapArticles;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public void setMapArticles(Map<String, Map<Integer, String>> mapArticles) {
		this.mapArticles = mapArticles;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public Map<String, Map<Integer, String>> getMapPrepositions() {
		return mapPrepositions;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public void setMapPrepositions(Map<String, Map<Integer, String>> mapPrepositions) {
		this.mapPrepositions = mapPrepositions;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public Map<String, Map<Integer, String>> getMapPronouns() {
		return mapPronouns;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public void setMapPronouns(Map<String, Map<Integer, String>> mapPronouns) {
		this.mapPronouns = mapPronouns;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public Map<String, Map<Integer, String>> getMapWordsToRemove() {
		return mapWordsToRemove;
	}

	/** FOR TESTING PURPOSES ONLY. */
	public void setMapWordsToRemove(Map<String, Map<Integer, String>> mapWordsToRemove) {
		this.mapWordsToRemove = mapWordsToRemove;
	}
